...
var webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      chunks: ['manifest', 'vendor', 'vuex02'], //需要引入的chunk，不配置就会引入所有页面的资源
      chunksSortMode: 'dependency'
    }),
    //----------多页 end
    ...
    //----------多页 start    
    new HtmlWebpackPlugin({
      filename: '../dist/stone_todomvc.html',
      template: 'src/stone-demo/todomvc/index.html',
      inject: true,
      minify: {
        removeComments: true,
        collapseWhitespace: true,
      ...
      chunks: ['manifest', 'vendor', 'stone_todomvc'], //需要引入的chunk，不配置就会引入所有页面的资源
      chunksSortMode: 'dependency'
    }),
    //----------多页 end
    //
